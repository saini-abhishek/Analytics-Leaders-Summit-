<?php
  ...
  if (isset($_POST['Continue'])) {
    ...
    $sql = "INSERT INTO Thailand_Enq(fname,lname,email,phone,company,designation,numofattend,event,comments) VALUES('$fname', '$lname', '$email', '$phone', '$company', '$designation', $numofattend, '$event', '$comments')";
